  ...
  return (
    <div className="deals-page">
      ...
      <header className="sticky-header">
        ...
        <p className="filter-row-label">Butiker</p>
            ...
            {storeButtons.map((store) => {
              ...
              return (
                <button
                  key={store}
                  type="button"
                  className={`store-btn${isActive ? " is-active" : ""}`}
                ...
                >
                  {isActive && <span className="store-emoji">{config.emoji}</span>}
        ...
        {storeCategories.length > 0 && (
          <>
            <p className="filter-row-label">Kategorier</p>
          <div style={{ borderBottom: "1px solid #ede9fe" }}>
            <div
              className="store-scroll"
              style={{
